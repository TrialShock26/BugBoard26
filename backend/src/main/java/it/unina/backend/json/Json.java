...
/**
 * Utility JSON minimale, scritta senza dipendenze esterne.
 * Il progetto non usa framework/librerie di terze parti per JSON o HTTP:
 * back-end e front-end restano cosi' completamente indipendenti e compilabili
 * con il solo JDK (vedi Sezione 3.2 della traccia: "il back-end deve essere
 * completamente indipendente dalla parte front-end").
 */
public class Json {
    ...
    /** Helper per costruire velocemente una Map ordinata: Json.obj("k1", v1, "k2", v2, ...) */
