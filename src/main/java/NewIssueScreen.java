    ...
    private void submit() {
        ...
        SwingWorker<Map<String, Object>, Void> worker = new SwingWorker<>() {
            ...
            protected Map<String, Object> doInBackground() {
                return ApiClient.createIssue(title, description, type, priority, labels, finalImageBase64);
            }
            ...
            protected void done() {
                ...
                try {
                    Map<String, Object> created = get();
                    JOptionPane.showMessageDialog(NewIssueScreen.this,
                            "Issue " + created.get("id") + " created successfully (status: TODO).",
