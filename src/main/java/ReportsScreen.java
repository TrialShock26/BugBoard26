    ...
    private void generateReport() {
        ...
        SwingWorker<Map<String, Object>, Void> worker = new SwingWorker<>() {
            ...
            protected Map<String, Object> doInBackground() {
                return ApiClient.monthlyReport(year, month);
            }
            ...
            protected void done() {
                try {
                    ...
                    openedLabel.setText(String.valueOf(report.get("opened")));
                    resolvedLabel.setText(String.valueOf(report.get("resolved")));
                    Object avg = report.get("avgResolutionHours");
                    avgLabel.setText(avg == null ? "N/A" : String.valueOf(avg));

                    perUserModel.setRowCount(0);
                    List<Map<String, Object>> perUser = (List<Map<String, Object>>) report.get("perUser");
                    for (Map<String, Object> row : perUser) {
                        Object userAvg = row.get("avgResolutionHours");
                        perUserModel.addRow(new Object[]{
                                row.get("email"), row.get("opened"), row.get("resolved"),
                    ...
                    List<Map<String, Object>> perTeam = (List<Map<String, Object>>) report.get("perTeam");
                    if (perTeam != null) {
                        for (Map<String, Object> row : perTeam) {
                            Object teamAvg = row.get("avgResolutionHours");
                            perTeamModel.addRow(new Object[]{
                                    row.get("team"), row.get("opened"), row.get("resolved"),
