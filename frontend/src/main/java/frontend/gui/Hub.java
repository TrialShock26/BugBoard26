...
import frontend.dto.SuggestionsDTO;
...
public class Hub extends BaseFrame {
    ...
    private JPanel createColumn(String title, Color color, List<IssueDTO> issueList) {
    ...
    private JPanel createIssueCard(IssueDTO issue) {
        ...
        JLabel priorityLabel = new JLabel(priority == null ? "NONE" : priority.name());
        ...
        JLabel typeLabel = new JLabel(String.valueOf(issue.getType()).toLowerCase());
